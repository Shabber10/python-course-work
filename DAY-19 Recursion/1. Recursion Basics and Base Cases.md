...
```text
[countdown_recursive(0)] -> Base case reached (Returns)
[countdown_recursive(1)] -> Suspended, waiting for countdown_recursive(0)
[countdown_recursive(2)] -> Suspended, waiting for countdown_recursive(1)
[countdown_recursive(3)] -> Active, waiting for countdown_recursive(2)
```
