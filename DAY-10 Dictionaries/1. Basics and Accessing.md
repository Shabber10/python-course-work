...
### Dictionary Key Constraints (Hashability)
...
* **Disallowed Keys:** Lists, dictionaries, or sets. Attempting to use a mutable sequence as a key will raise a **`TypeError: unhashable type`**.
